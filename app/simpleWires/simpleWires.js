...
angular.module('myApp.simpleWires', ['ngRoute', 'ui.bootstrap'])

    .config(['$routeProvider', function ($routeProvider) {
        $routeProvider.when('/simpleWires', {
            templateUrl: 'simpleWires/simpleWires.html',
            controller: 'SimpleWireController'
        });
    }])

    .controller('SimpleWireController', ['$scope', '$route', function ($scope, $route) {
